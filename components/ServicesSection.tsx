        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {services.map((service, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-blue-50 to-white border border-blue-100 rounded-2xl p-6 hover:shadow-lg transition-all duration-300"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {learningContents.map((content, index) => (
              <motion.div
                ...
                className="bg-white/20 backdrop-blur-sm rounded-xl px-4 py-3 text-center"
              >
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {designCatalog.map((design, index) => (
              ...
              >
                <div className={`h-32 bg-gradient-to-br ${design.color} rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300`}>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white/90 backdrop-blur-sm rounded-lg p-2">
                      <p className="text-xs font-medium text-gray-800">{design.name}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
